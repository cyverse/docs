...
type: API Overview
title: "Terrain"
description: "The Terrain API: what it fronts, how to authenticate, and where the generated reference lives."
tags: [api, terrain]
status: stable
...
* [Endpoints Index](./endpoint-index.md)
...
## [Tapis v2 App migration to v3 for the Discovery Environment](./tapis-v2-v3-migration.md)
