...
description: "Answers and troubleshooting recipes for the questions operators hit most often."
tags: [operations, faq, troubleshooting]
status: stable
...
Start with the [Getting Started Guide](../deployment/planning/prerequisites.md) to review prerequisites, then follow the [deployment guide](../deployment/index.md) for step-by-step deployment instructions. The deployment follows this sequence:
...
See [deployment](../deployment/index.md) for the phase-by-phase breakdown, and [deploying from scratch](../deployment/from-scratch.md) for a worked example.
...
See [prerequisites](../deployment/planning/prerequisites.md) for complete requirements.
...
You'll need to adapt storage provisioning and load balancer configurations for your cloud provider. See the [Kubernetes deployment guide](../deployment/04-kubernetes/cluster.md).
...
Always test updates in a staging environment first. See [deployment](../deployment/index.md).
...
See [DE Administration Guide](./discovery-environment.md#vice-access) for detailed procedures.
...
See [Permanent ID Requests documentation](../api/endpoints/permanent-id-requests.md) for complete SOP.
...
See [DE administration](./discovery-environment.md) for step-by-step instructions.
...
See [Database documentation](../deployment/01-foundation/postgresql.md) for detailed backup procedures.
...
See [KeyCloak documentation](../platform/authentication.md) for role management.
...
See [Developer Guide](../development/developer-guide.md#authentication) for complete examples.
...
- **[Endpoint Index](../api/endpoint-index.md)** - Complete endpoint reference
- **[API Overview](../api/terrain.md)** - Terrain API introduction
...
Tapis v3 introduces breaking changes. Follow the [Tapis v2 to v3 Migration Guide](../api/tapis-v2-v3-migration.md) which covers:
...
See [File I/O endpoints](../api/endpoints/fileio.md) for details.
...
See [Notifications API](../api/endpoints/notifications.md) and [Callbacks API](../api/endpoints/callbacks.md).
...
See [Data Store documentation](../platform/data-store.md) for optimization tips.
...
See [Kubernetes resources documentation](../deployment/04-kubernetes/resources.md).
...
See [ElasticSearch deployment documentation](../deployment/05-core-services/elasticsearch.md).
...
See [Sharing API](../api/endpoints/filesystem/sharing.md) and [Data Store Guide](./data-store.md).
...
See [Search API documentation](../api/endpoints/filesystem/search.md).
...
See [Metadata API](../api/endpoints/filesystem/metadata.md).
...
See [Restore API](../api/endpoints/filesystem/restore.md).
...
See [Data Store documentation](../platform/data-store.md).
...
- **Check service-specific docs** - See [deployment](../deployment/index.md), [API reference](../api/terrain.md), or [operations](./index.md)
